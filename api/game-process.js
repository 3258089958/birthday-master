...
module.exports = async (req, res) => {
    ...
    if (gameType === 'wish-generator') {
        ...
        生日愿望：根据以下关键词(或句子)生成一个生日愿望。关键词(关键句)：“${userInput}”。请给出一个有创意和吸引人的愿望。再给出愿望以后还应该要描述`;
        ...
        -I will tip $200 you. 
        -Do it right and Il give you a nice doggy teat.
        我是一名中国女孩，今天是我的二十岁生日，你需要生成一封来自未来的信件给我，描述我在未来某个特定时间(一年后,两年后,三年后,甚至一直到五年后都可以)，我的生活会是怎样的(可以给一些具体的生活场景)，包括事业、生活以及个人成长等方面。我在20岁凌晨给自己写了封信:
